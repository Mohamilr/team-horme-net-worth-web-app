      ...
      >
        ...
        <div class="form_container input-field1">
          ...
          <input
            type="text"
            name="tokencode"
            class="form-control input_pass1"
        ...
        <div class="form_container input-field2">
          ...
          <input
            type="password"
            name="newpassword"
            class="form-control input_pass2"
            placeholder="Enter new password *"
            style="color: white;"
          />
        </div>
        <div class="send_button">
          <button type="submit" name="resetnow" class="btn btn-block btn-lg">
            Create New Password
          </button>
        </div>
        <br />
        ...
        <div class="text-center small footer">
          Not yet Registered?
          <a href="index.php" class="bottom_signup"> Sign up/ Sign in</a>
        </div>
      </form>
    </div>
